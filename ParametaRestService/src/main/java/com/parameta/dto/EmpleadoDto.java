...
public class EmpleadoDto {
    ...
    private Tiempo tiempoVinculacion;
    private Tiempo edadActual;
    ...
    /**
     * @return the tiempoVinculacion
     */
    public Tiempo getTiempoVinculacion() {
        return tiempoVinculacion;
    }

    /**
     * @param tiempoVinculacion the tiempoVinculacion to set
     */
    public void setTiempoVinculacion(Tiempo tiempoVinculacion) {
     ...
     */
    public Tiempo getEdadActual() {
        return edadActual;
    }

    /**
     * @param edadActual the edadActual to set
     */
    public void setEdadActual(Tiempo edadActual) {
